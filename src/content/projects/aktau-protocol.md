...
- **Heat** - Generated by reactor, consumed by desalination and housing (2× in winter)
...
| Condition | Result |
|-----------|--------|
| Reactor ≥ 100°C | ☢️ Nuclear meltdown |
| Fresh water < 0 | 🏜️ City drought |
| Heat < 0 | ❄️ City frozen |
| Population = 0 | 💀 Extinction |
| Happiness = 0 | ✊ Citizens revolt |
